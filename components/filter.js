        ...
        <div className={styles.filterContainer}>
            ...
            <div className="container">
                ...
                <div className="row">
                    {
                        year.map((yr, i) => {
                            return <div key={i} className="col-sm-6 col-lg-4" style={{ margin: 5 }}><button key={Math.random()} onClick={(e) => onButtonClick(e, "launch_year", yr)} className={styles.filterButton}>{yr}</button></div>
                        })
                    }
                </div>
                <br />
                ...
                <div className="row">
                    <div className="col-sm-6 col-lg-4" style={{ margin: 5 }}>
